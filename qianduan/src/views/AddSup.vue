<template>
    <div class="addSup">
      <div class="t1">
        ...
        <div class="msg">
            ...
            <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;在营</span><input type="radio" value="" v-model="form.registrationStatus">
            <span>&nbsp;&nbsp;&nbsp;开业</span><input type="radio" value="2" v-model="form.registrationStatus">
            <span>&nbsp;&nbsp;&nbsp;注册</span><input type="radio" value="3" v-model="form.registrationStatus">
            <br>
  ...
  <div class="ctl">
    <button class="bt1" @click="add()">保存</button>
